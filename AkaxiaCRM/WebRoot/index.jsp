...
<html>
  <head>
    ...
    <title>京紫宇宙客户关系管理系统</title>
	
  </head>
  
  <frameset rows="280,*" cols="*" frameborder="NO" border="0" framespacing="0">
	   ...
	   <frameset  id="mainframe" rows="*" cols="200,9,*" framespacing="0" frameborder="NO" border="0" bordercolor="#404040">
	         ...
	         <frame scrolling=NO  noresize="true" name="toogle" marginwidth="0" marginheight="0" src="toogle.jsp">
